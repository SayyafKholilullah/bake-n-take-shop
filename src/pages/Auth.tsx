...
const nameSchema = z.string().trim().min(2, { message: "Nama minimal 2 karakter" }).max(100);
...
const Auth = () => {
  ...
  useEffect(() => {
    document.title = tab === "login" ? "Masuk | ManisBakery" : "Daftar | ManisBakery";
  }, [tab]);
    ...
    <main className="pt-24 pb-20 min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-card border rounded-2xl p-6 shadow-sm">
            ...
            <TabsContent value="login">
              <form onSubmit={handleLogin} className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input id="login-email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} required maxLength={255} />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="login-password">Password</Label>
                  <Input id="login-password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} required maxLength={72} />
                </div>
            ...
            <TabsContent value="signup">
              <form onSubmit={handleSignup} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="signup-password" type="password" value={password} onChange={(e) => setPassword(e.target.value)} required maxLength={72} />
          ...
          <Button type="button" variant="outline" className="w-full" size="lg" onClick={handleGoogle} disabled={loading}>
